...
void TSL2561_Init(TSL2561* tsl, I2C_Config_t* userHandle, uint8_t sensorAddress)
{
...
void TSL2561_GetLux(uint16_t data0,uint16_t data1, float* luxValue)
{
...
void TSL2561_ReadData(TSL2561* tsl, uint16_t* data0Val, uint16_t* data1Val)
{
...
void TSL2561_WriteByte(TSL2561* tsl, uint8_t reg, uint8_t value)
{
	//return HAL_I2C_Mem_Write(tsl->i2cHandle, tsl->address, reg, 1, &value, 1, TSL2561_MAX_DELAY);
}

void TSL2561_ReadByte(TSL2561* tsl, uint8_t reg, uint8_t* value)
{
